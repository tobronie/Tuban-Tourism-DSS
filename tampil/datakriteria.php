            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="../aksi/insertkriteria.php">
                                <div id="multi-insert-container">
                                    <div class="row mb-3">
                                        <div class="col-md-5">
                                            <label for="exampleInputNama" class="form-label">Nama Kriteria</label>
                                            <input required type="text" name="nama[]" class="form-control"
                                                placeholder="Masukkan Data Nama Kriteria yang Benar"
                                                aria-label="namaHelp">
                                        </div>
                                        <div class="col-md-5">
                                            <label for="exampleInputTipe" class="form-label">Tipe Kriteria</label>
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    include '../config.php';
                                    $i = 1;
                                    $data = mysqli_query($config, "SELECT * FROM kriteria");
                                    while ($d = mysqli_fetch_array($data)) {
                                        ?>
                                        <tr>
                                            <th>
                                                <?php echo $d['id_kriteria']; ?>
                                            </th>
                                            <th>
                                            ...
                                            <th>
                                                <a href="../delete/deletekriteria.php?id_kriteria=<?= $d['id_kriteria']; ?>"
