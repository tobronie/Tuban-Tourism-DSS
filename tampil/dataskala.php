            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="../aksi/insertskala.php">
                                <div id="multi-insert-container">
                                    <div class="row mb-3">
                                        <div class="col-md-5">
                                            <label for="exampleInputValue" class="form-label">Value Skala</label>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <input required type="text" name="keterangan[]" class="form-control"
                                                placeholder="Masukkan Data Keterangan dengan Benar"
                                                aria-label="keteranganHelp">
                                        </div>
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    include '../config.php';
                                    $i = 1;
                                    $data = mysqli_query($config, "SELECT * FROM skala");
                                    while ($d = mysqli_fetch_array($data)) {
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <a href="../delete/deleteskala.php?id_skala=<?= $d['id_skala']; ?>"
