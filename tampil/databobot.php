            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="../aksi/insertbobot.php">
                                <div id="multi-insert-container">
                                    <div class="row mb-3">
                                        <div class="col-md-5">
                                            <label for="exampleInputID_B" class="form-label">Nama Kriteria</label>
                                            <select name="nm_kriteria[]" class="form-select" required>
                                                <?php
                                                include '../config.php';
                                        ...
                                        <div class="col-md-5">
                                            <label for="exampleInputValue" class="form-label">Value Bobot</label>
                                            <input required type="text" name="value[]" class="form-control"
                                                placeholder="Masukkan Data Value Bobot dengan Angka"
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    include '../config.php';
                                    $i = 1;
                                    $data = mysqli_query($config, "SELECT bobot.id_bobot, kriteria.nm_kriteria, bobot.value
                                    FROM bobot
                                    JOIN kriteria ON bobot.id_kriteria = kriteria.id_kriteria
                                    ORDER BY bobot.id_bobot");
                                    while ($d = mysqli_fetch_array($data)) {
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <a href="../delete/deletebobot.php?id_bobot=<?= $d['id_bobot']; ?>"
